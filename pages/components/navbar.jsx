  ...
  return (
    <>
      {params !== "/kelas/fresh-sale" && (
        <div className="w-full bg-[#110843] py-6 px-20 max-sm:px-4 max-md:gap-8 flex md:flex-row md:justify-between flex-col items-center z-10 relative">
          <div className="flex gap-4 max-md:flex-col max-md:items-center -mt-2">
            <Image
              src={"/img/top-nav-giat-belajar-final.png"}
              width={150}
              className="-mt-2"
              height={50}
              alt="promo-giat-belajar"
            />
            <p className="text-white font-semibold text-xl max-md:text-center">
              Premium Sale <br />{" "}
              <span className="font-extrabold">Discount 90% All Class</span>
            </p>
          </div>
          <div className="flex md:gap-4 lg:flex-row items-start flex-col max-md:items-center max-md:gap-4 lg:items-center">
            <div className="flex gap-x-2 items-center">
              <Image
                src="/icon/checklist-top.svg"
                width={24}
                height={24}
                alt="check"
              />
            ...
            <button
              onClick={() => router.push("/kelas/fresh-sale")}
              className=" bg-prime  py-3 px-8 rounded-full text-md font-extrabold text-white border-4 border-[#110843] hover:border-[#11084370] transition-all"
            >
              Ambil Promo
            </button>
          </div>
