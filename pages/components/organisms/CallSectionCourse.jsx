    ...
    <div className="container  place-content-start lg:px-8 px-4 mx-auto relative mt-20 h-fit ">
      <div className="flex items-center flex-wrap justify-center gap-y-6  md:gap-x-16 relative z-30">
        ...
        <div className="space-y-6 md:mt-[10px] max-md:text-center max-md:pb-20">
          ...
          <button className="px-8 mt-6 bg-second border-4 max-lg:mx-auto flex gap-2 border-[#fff] box-content hover:border-[#6de0b6] transition-all rounded-full text-white font-bold py-3">
            <span>
