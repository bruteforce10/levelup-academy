  ...
  const handleBuy = async () => {
    if (session === null) {
      ...
      if (payResult) {
        setIsPending(true);
        window.open(
          `https://api.whatsapp.com/send?phone=6285888139106&text=hi%20mimin%20saya%20dengan%20email:%20${email}%20ingin%20membeli%20produk%20${title}%20ini%20dengan%20harga%20${Discount(
            price
          )}`,
          "_blank"
        );
